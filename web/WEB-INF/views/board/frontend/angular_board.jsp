    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="#angular">Angular</a></li>
                <li><a class="nav-link scrollto" href="#angular-contents">Contents</a></li>
...
<main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section id="angular" class="about">
        <div class="container">
            ...
            <div class="row no-gutters">
                <div class="content col-xl-5 d-flex align-items-stretch" data-aos="fade-up">
                    <div class="content">
                        ...
                        <p>
                            이 곳은 Angular와 관련된 질문이나 토론을 할 수 있는 게시판입니다.
                            코드를 공유하거나 질문 해보세요.
    ...
    <!-- ======= Contents Section ======= -->
    <section id="angular-contents" class="services mb-5">
        <div class="container">
                ...
                <form>
                    <div class="d-flex justify-content-center">
                        <div class="input-group mb-3 me-1" style="width: 625px;">
                            ...
                            <input type="hidden" name="langname" value="angular">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/front/upload" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" id="content-lang" value="angular" name="contentLangName">
