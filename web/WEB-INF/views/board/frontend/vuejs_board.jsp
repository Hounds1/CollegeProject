    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="#vue">Vue.js</a></li>
                <li><a class="nav-link scrollto" href="#vue-contents">Contents</a></li>
...
<main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section id="vue" class="about">
        <div class="container">

            <div class="row no-gutters">
                <div class="content col-xl-5 d-flex align-items-stretch" data-aos="fade">
                    <div class="content">
                        <h3><i class="bx bxl-vuejs"></i> Vue.js</h3>
                        <p>
                            이 곳은 Vue.js와 관련된 질문이나 토론을 할 수 있는 게시판입니다.
                            코드를 공유하거나 질문 해보세요.
                    ...
                    <div class="icon-boxes d-flex flex-column justify-content-center">
                        <div class="row">
                            ...
                            <div class="col-md-6 icon-box" data-aos="fade" data-aos-delay="400">
                                ...
                                <h4>Community</h4>
                                <p>활발한 커뮤니티 활동으로 해답을 구하기 유리합니다.</p>
                            </div>
                        </div>
                    </div><!-- End .content-->
                </div>
    ...
    <!-- ======= Contents Section ======= -->
    <section id="vue-contents" class="services mb-5">
        <div class="container">
                ...
                <form>
                    <div class="d-flex justify-content-center">
                        <div class="input-group mb-3 me-1" style="width: 625px;">
                            ...
                            <input type="hidden" name="langname" value="vuejs">
            ...
            <div class="pagination-wrap mt-5 d-flex justify-content-center" data-aos="fade-in" data-aos-delay="100">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li class="page-item"><a class="page-link" href="?page=1&langname=vuejs">처음</a></li>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.prev}&langname=vuejs" aria-label="Previous">
                        ...
                        <c:forEach var="page" items="${pager.list}">
                            <li class="page-item">
                                <a class="page-link ${page eq pager.page ? 'active' : ''}"
                                   href="?page=${page}&langname=vuejs">${page}</a>
                            </li>
                        </c:forEach>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.next}&langname=vuejs" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span>
                            </a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.last}&langname=vuejs">마지막</a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/front/upload" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" id="content-lang" value="vuejs" name="contentLangName">
