    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="#react">React</a></li>
                <li><a class="nav-link scrollto" href="#react-contents">Contents</a></li>
...
<main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section id="react" class="about">
        <div class="container">

            <div class="row no-gutters">
                <div class="content col-xl-5 d-flex align-items-stretch" data-aos="fade-up">
                    <div class="content">
                        <h3><i class="bx bxl-react"></i> React</h3>
                        <p>
                            이 곳은 React 관련된 질문이나 토론을 할 수 있는 게시판입니다.
                            코드를 공유하거나 질문 해보세요.
                    ...
                    <div class="icon-boxes d-flex flex-column justify-content-center">
                        <div class="row">
                            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                                <i class="bi bi-pip"></i>
                                <h4>Component</h4>
                                <p>각 소요를 따로 구성함으로 페이지를 새로고침 하지 않습니다.</p>
                            </div>
                            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                                <i class="bx bxl-react"></i>
                                <h4>Framework</h4>
                                <p>Angular와 같이 프레임워크 급으로 여겨집니다.</p>
                            </div>
                            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                                <i class="bi bi-person-plus"></i>
                                <h4>Users</h4>
                                <p>프론트엔드 프레임워크 중 가장 많은 유저를 보유 중입니다.</p>
                            </div>
                            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                                <i class="bi bi-recycle"></i>
                                <h4>Flexibility</h4>
                                <p>웹 프로젝트만이 아닌 모바일 앱, 데스크탑 앱도 유연하게 구현이 가능합니다.</p>
                            </div>
                        </div>
                    </div><!-- End .content-->
                </div>
    ...
    <!-- ======= Contents Section ======= -->
    <section id="react-contents" class="services mb-5">
        <div class="container">
                ...
                <form>
                    <div class="d-flex justify-content-center">
                        <div class="input-group mb-3 me-1" style="width: 625px;">
                            ...
                            <input type="hidden" name="langname" value="react">
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100"
                            ...
                            <h4 class="title"
                                ...
                                <a href="/front/detail/${list.contentNum}">${list.contentTitle}</a>
                            </h4>
            ...
            <div class="pagination-wrap mt-5 d-flex justify-content-center" data-aos="fade-in" data-aos-delay="100">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li class="page-item"><a class="page-link" href="?page=1&langname=react">처음</a></li>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.prev}&langname=react" aria-label="Previous">
                        ...
                        <c:forEach var="page" items="${pager.list}">
                            <li class="page-item">
                                <a class="page-link ${page eq pager.page ? 'active' : ''}"
                                   href="?page=${page}&langname=react">${page}</a>
                            </li>
                        </c:forEach>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.next}&langname=react" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span>
                            </a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.last}&langname=react">마지막</a>
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/front/upload" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <input type="hidden" id="content-lang" value="react" name="contentLangName">
...
<script src="frontendboard/summernote.js"></script>
