        ...
        <div class="container">
                ...
                <form>
                    <div class="d-flex justify-content-center">
                        <div class="input-group mb-3 me-1" style="width: 625px;">
                            ...
                            <input type="hidden" name="langname" value="kotlin">
            ...
            <div class="pagination-wrap mt-5 d-flex justify-content-center" data-aos="fade-in" data-aos-delay="100">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li class="page-item"><a class="page-link" href="?page=1&langname=kotlin">처음</a></li>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.prev}&langname=kotlin" aria-label="Previous">
                        ...
                        <c:forEach var="page" items="${pager.list}">
                            <li class="page-item">
                                <a class="page-link ${page eq pager.page ? 'active' : ''}"
                                   href="?page=${page}&langname=kotlin">${page}</a>
                            </li>
                        </c:forEach>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.next}&langname=kotlin" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span>
                            </a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.last}&langname=kotlin">마지막</a>
                        </li>
                    </ul>
                </nav>
            </div>
