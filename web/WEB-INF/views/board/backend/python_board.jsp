    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="#python">Python</a></li>
                <li><a class="nav-link scrollto" href="#python-contents">Contents</a></li>
...
<main id="main">
    ...
    <!-- ======= Contents Section ======= -->
    <section id="python-contents" class="services mb-5">
        <div class="container">
                ...
                <form>
                    <div class="d-flex justify-content-center">
                        <div class="input-group mb-3 me-1" style="width: 625px;">
                            ...
                            <input type="hidden" name="langname" value="python">
            ...
            <div class="pagination-wrap mt-5 d-flex justify-content-center" data-aos="fade-in" data-aos-delay="100">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li class="page-item"><a class="page-link" href="?page=1&langname=python">처음</a></li>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.prev}&langname=python" aria-label="Previous">
                        ...
                        <c:forEach var="page" items="${pager.list}">
                            <li class="page-item">
                                <a class="page-link ${page eq pager.page ? 'active' : ''}"
                                   href="?page=${page}&langname=python">${page}</a>
                            </li>
                        </c:forEach>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.next}&langname=python" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span>
                            </a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="?page=${pager.last}&langname=python">마지막</a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/back/upload" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" id="content-lang" value="python" name="contentLangName">
